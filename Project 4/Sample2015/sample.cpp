...
const char *WINDOWTITLE = { "Project 4 -- Nicholas Skinner" };
...
InitMenus()
{
	...
	int manLightMenu = glutCreateMenu(DoManualLightMenu);
	glutAddMenuEntry("Off", 0);
	glutAddMenuEntry("On", 1);
	...
	glutAddSubMenu("Manual Mode", manLightMenu);
